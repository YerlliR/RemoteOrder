document.addEventListener('DOMContentLoaded', function() {
    ...
    // Función para crear el modal de pedido con diseño mejorado
            ...
            <div id="modal-pedido" class="modal">
                <div class="modal-content modal-pedido-content">
                    ...
                    <div class="modal-body-flex">
                        <div class="productos-section-left">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" id="btn-confirmar-pedido" disabled>
    ...
    // Función para mostrar productos con diseño mejorado
                ...
                html += `
                    <div class="producto-pedido-item" data-producto-id="${producto.id}">
                        ...
                        <div class="producto-info-pedido">
                            ...
                            <div class="producto-precio-pedido">
                        ...
                        <div class="producto-cantidad-control">
                            <button class="btn-cantidad btn-menos" data-producto-id="${producto.id}">
                                <i class="fas fa-minus"></i>
                            </button>
                            <input type="number" class="cantidad-input" value="0" min="0" max="999"
                                   data-producto-id="${producto.id}"
                                   data-precio="${producto.precio}"
                                   data-iva="${producto.iva}"
                                   data-nombre="${producto.nombre_producto}">
                            <button class="btn-cantidad btn-mas" data-producto-id="${producto.id}">
    ...
    function filtrarProductos(busqueda) {
        ...
        items.forEach(item => {
            ...
            const codigo = item.querySelector('.producto-codigo').textContent.toLowerCase();
