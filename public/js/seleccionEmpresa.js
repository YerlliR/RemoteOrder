document.addEventListener('DOMContentLoaded', () => {
    const initSeleccionEmpresa = () => {
        ...
        setTimeout(() => {
            showAlert({
                type: 'info',
                title: '¡Bienvenido a RemoteOrder!',
                message: 'Selecciona una empresa para acceder al panel de gestión',
                duration: 4000
            });
        }, 500);
        ...
        if (totalEmpresas === 0) {
            ...
            setTimeout(() => {
                showAlert({
                    type: 'info',
                    title: 'Una empresa disponible',
                    message: 'Tienes una empresa registrada. También puedes crear empresas adicionales.',
                    duration: 5000
                });
            }, 2000);
        } else {
            setTimeout(() => {
                showAlert({
                    ...
                    message: `Tienes ${totalEmpresas} empresas registradas. Selecciona una para continuar.`,
                    duration: 4000
                });
            }, 2000);
        }
